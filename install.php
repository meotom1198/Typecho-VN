    ...
    try {
        ...
        $installDb->query(
            $installDb->insert('table.contents')->rows([
                'title' => _t('Cài đặt thành công Typecho VN'),
                'slug' => 'start', 'created' => \Typecho\Date::time(),
                'modified' => \Typecho\Date::time(),
                'text' => '<!--markdown-->' . _t('Nếu bạn thấy bài viết này thì nghĩa là blog của bạn đã được cài đặt thành công.'),
                'authorId' => 1,
                'type' => 'post',
                'status' => 'publish',
                'commentsNum' => 1,
        ...
        $installDb->query(
            $installDb->insert('table.comments')->rows([
                ...
                'text' => 'Đây là "Bình luận mặc định" được tạo tự động sau khi mã nguồn "Typecho VN" được cài đặt thành công.',
                'type' => 'comment',
                'status' => 'approved',
                'parent' => 0
            ])
